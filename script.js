const tracks = [
    {
        ...
        cover: "Thodi-Si-Daaru.jpg",
        url: "Thodi-Si-Daaru.mp3"
    },
    {
        id: 2,
        name: "Pal Pal",
...
tracks.forEach(track => {
    ...
    item.innerHTML = `
        <img src="${track.cover}" width="80" height="80">
        <div>${track.name}</div>
        <div>${track.artist}</div><br>
        <button onclick="playTrack(${track.id})"><i class="fa fa-play"></i>▶</button><br>
...
function renderPlayer() {
    ...
    playerDiv.innerHTML = `
        <img src="${currentTrack.cover}" width="120" height="120"><br>
